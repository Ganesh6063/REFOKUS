   ...
   const [images, setImages] =useState(
    ...
    <div className='w-full mt-20 mb-20'>
        <div className='relative max-w-screen-xl mx-auto text-center'>
            <h1 className='text-[27vw] leading-none  select-none font-medium tracking-tight '>WORK</h1>
           <div className=' absolute top-0 w-full h-full'>
           {images.map(
            (elem, index)=>
           (elem.isActive && (
              <img
              key={index} className='absolute w-60 rounded-lg -translate-x-[5%] -translate-y-[50%] ' 
              src={elem.URL} 
